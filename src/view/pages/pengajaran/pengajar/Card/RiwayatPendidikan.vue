...
export default {
    ...
    data(){
        return {
            ...
            update_riwayat_pendidikan: [],
            delete_riwayat_pendidikan: [],
            add_riwayat_pendidikan: {
                tingkat: "",
                nama_sekolah: "",
                tahun_masuk: "",
                tahun_lulus: "",
    ...
    computed: {
        ...
        formInput() {
            return this.editedIndex === -1 ? this.add_riwayat_pendidikan : this.editedItem;
        },
        formSubmit() {
    ...
    methods:{
        getMasterRiwayat(){
            return new Promise(resolve => {
                ...
                Services.PostData(
                    ApiService,
                    "Riwayat/Riwayat_Pendidikan_Pengajar",
                    qs.stringify(mydata),
                    contentType,
                    response => {
                        resolve(response.data);
                        this.riwayat_pendidikan = response.data;
                    },
                    err => {
                        err;
                    }
        ...
        createRiwayat(){
            return new Promise(resolve => {
                var mydata = {
                    ...
                    Route: "DEFAULT",
                    pengajar_id: this.Pengajar_Id,
                    tingkat: this.add_riwayat_pendidikan.tingkat,
                    nama_sekolah: this.add_riwayat_pendidikan.nama_sekolah,
                    tahun_lulus: this.add_riwayat_pendidikan.tahun_lulus,
                    tahun_masuk: this.add_riwayat_pendidikan.tahun_masuk,
                    status_sekolah: this.add_riwayat_pendidikan.status_sekolah,
                    alamat_riwayat: this.add_riwayat_pendidikan.alamat_riwayat,
                    keterangan_riwayat: this.add_riwayat_pendidikan.keterangan_riwayat,
                };
                ...
                response => {
                    ...
                    this.create_riwayat_pendidikan = response.data;
                    this.submitted = true;
                    this.save("add_riwayat_pendidikan");
        ...
        editItem (item) {
            this.editedIndex = this.riwayat_pendidikan.indexOf(item)
            ...
            Swal.fire({
                ...
                return new Promise(resolve => {
                    var mydata = {
                        ...
                        Trigger: "D",
                        Route: "DEFAULT",
                        r_pendidikan_pengajar_id: item.r_pendidikan_pengajar_id
                    };
                    ...
                    Services.PostData(
                        ...
                        response => {
                            ...
                            this.delete_riwayat_pendidikan = response.data;
                            this.submitted = true;
                            this.riwayat_pendidikan.splice(this.deletedIndex, 1);
                            this.getMasterRiwayat()
                        },
                        err => {
                            err;
        ...
        close () {
            this.dialog = false
            this.$nextTick(() => {
                this.add_riwayat_pendidikan.status_sekolah = ""
                this.add_riwayat_pendidikan.alamat_riwayat = ""
                this.add_riwayat_pendidikan.keterangan_riwayat = ""
                this.add_riwayat_pendidikan.nama_sekolah = ""
                this.add_riwayat_pendidikan.tahun_lulus = ""
                this.add_riwayat_pendidikan.tahun_masuk = ""
                this.add_riwayat_pendidikan.tingkat = ""
        ...
        updateKurikulum() {
            return new Promise(resolve => {
                var mydata = {
                    ...
                    Trigger: "U",
                    Route: "DEFAULT",
                    r_pendidikan_pengajar_id: this.data_item.r_pendidikan_pengajar_id,
                    pengajar_id: this.Pengajar_Id,
                ...
                Services.PostData(
                    ...
                    response => {
                        ...
                        this.update_riwayat_pendidikan = response.data;
                        this.submitted = true;
                        this.save("edit_riwayat_pendidikan");
                        this.getMasterRiwayat();
                    },
                    err => {
                        err;
        ...
        save(formInput) {
            if (formInput == "add_riwayat_pendidikan") {
                if (this.editedIndex > -1) {
                Object.assign(
                    this.riwayat_pendidikan[this.editedIndex],
                    this.add_riwayat_pendidikan
                );
                } else {
                    this.riwayat_pendidikan.push(this.add_riwayat_pendidikan);
                }
            } else if (formInput == "edit_riwayat_pendidikan") {
                if (this.editedIndex > -1) {
                    Object.assign(this.riwayat_pendidikan[this.editedIndex], this.editedItem);
                } else {
                    this.riwayat_pendidikan.push(this.editedItem);
                }
            }
            this.close();
        },
